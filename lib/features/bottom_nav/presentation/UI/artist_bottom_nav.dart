...
class ArtistBottomNav extends StatelessWidget {
  const ArtistBottomNav({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(ArtistBottomNavController());
...
class _AppBottomNavBar extends StatelessWidget {
  ...
  final ArtistBottomNavController controller;
          ...
          child: Obx(
            () => Row(
              ...
              children: List.generate(
                controller.artistitems.length,
                (index) => _NavBarItem(
                  item: controller.artistitems[index],
